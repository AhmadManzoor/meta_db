...
class AbstractMetaMasterInvoiceModel(models.Model):
    ...
    """
    which_place = models.CharField(max_length=10, db_column='TBWhichPlace', blank=True, default='Web')
    # BILLING ADDRESS
    # ctcompanyname = models.CharField(max_length=100, db_column='CTCompanyName', blank=True)
    bill_first_name = models.CharField(max_length=50, db_column='CTCustomerFirstName', blank=True)
    bill_last_name = models.CharField(max_length=50, db_column='CTCustomerLastName', blank=True)
    bill_address1 = models.CharField(max_length=200, db_column='CTAddress1', blank=True)
    bill_address2 = models.CharField(max_length=60, db_column='CTAddress2', blank=True)
    bill_city = models.CharField(max_length=50, db_column='CTCity', blank=True)
    bill_state = models.CharField(max_length=50, db_column='CTState', blank=True)
    bill_zipcode = models.CharField(max_length=50, db_column='CTZip', blank=True)
    bill_country = models.CharField(max_length=50, db_column='CTCountry', blank=True)
    bill_phone_number = models.CharField(max_length=50, db_column='CTPhone', blank=True)
    # SHIPPING INFO
    mail_company_name = models.CharField(max_length=100, db_column='CTMailCompanyName', blank=True)
    mail_attention_name = models.CharField(max_length=50, db_column='CTMailAttention', blank=True)
    mail_address1 = models.CharField(max_length=200, db_column='CTMailAddress1', blank=True)
    mail_address2 = models.CharField(max_length=60, db_column='CTMailAddress2', blank=True)
    mail_city = models.CharField(max_length=50, db_column='CTMailCity', blank=True)
    mail_state = models.CharField(max_length=50, db_column='CTMailState', blank=True)
    mail_zipcode = models.CharField(max_length=50, db_column='CTMailZip', blank=True)
    mail_country = models.CharField(max_length=50, db_column='CTMailCountry', blank=True)
    mail_phone_number = models.CharField(max_length=50, db_column='CTMailPhone', blank=True)
    # CARD INFO
    card_type = models.CharField(max_length=255, db_column='CardType', blank=True)
    card_number = models.CharField(max_length=255, db_column='CardNumber', blank=True)

    card_expire_month = models.CharField(max_length=255, db_column='CardExpireMonth', blank=True)
    card_expire_year = models.CharField(max_length=255, db_column='CardExpireYear', blank=True,
                                        help_text='card security code')
    payment_profile_id = models.CharField(max_length=50, db_column='PaymentProfileID', blank=True)
    customer_comment = models.CharField(max_length=3000, db_column='CommentsByCustomer', blank=True,
                                        help_text='a leaved message when it ordered')
    customer_ip_address = models.CharField(max_length=30, db_column='CustomerIP_Address', blank=True,
                                           help_text='user ip')
    reserved_store_credit = models.DecimalField(decimal_places=4, max_digits=19, db_column='ReservedStoreCredit',
                                                blank=True, default=0.00, help_text='reserved store credit')
