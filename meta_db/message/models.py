...
class AbstractMessageThreadModel(models.Model):
    ...
    reference_number = models.CharField(max_length=20,
                                        db_column='reference_num')
    is_active = models.BooleanField(
        db_column='is_active', default=True)  # TODO: help_text for this field
    created = models.DateTimeField(db_column='created', auto_now_add=True)
    status = models.CharField(max_length=1,
                              db_column='os_status',
                              default='O',
                              help_text='flags for os staff')

    @property
    def message_count(self):
        return MessageModel.objects.filter(messagethread=self,
...
class MessageThreadModel(AbstractMessageThreadModel):
    ...
    customer = models.ForeignKey('meta_db.UserModel',
                                 ...
                                 on_delete=models.DO_NOTHING)
    topic_type = models.ForeignKey(MessageTopicModel,
                                   db_column='reference_type',
                                   on_delete=models.DO_NOTHING)
...
class AbstractMessageModel(models.Model):
    ...
    body = models.CharField(max_length=2000,
                            ...
                            blank=True,
                            null=True)
    is_brand_sent = models.BooleanField(db_column='is_vendor_sent',
                                        default=False,
                                        help_text='')  # TODO: check purpose
    is_read = models.BooleanField(db_column='is_read', default=False)
    notification_status = models.BooleanField(db_column='is_noti_status',
                                              default=False)
    created = models.DateTimeField(db_column='created', auto_now_add=True)
    image_url = models.CharField(max_length=100,
                                 db_column='image_link',
                                 blank=True,
                                 null=True)
    sender_id = models.CharField(max_length=50,
                                 ...
                                 blank=True,
                                 null=True,
                                 help_text='brand or os staff id')
    sender_name = models.CharField(max_length=50,
                                   db_column='sender_name',
                                   blank=True,
                                   null=True,
                                   help_text='brand or os staff name')
...
class MessageModel(AbstractMessageModel):
    thread = models.ForeignKey('meta_db.MessageThreadModel',
                               db_column='messagethread_id',
