...
from meta_db.user.models import CreditCardAuthorizationFormModel
...
class AbstractMasterInvoiceModel(AbstractMetaMasterInvoiceModel):
    ...
    ordered_date = models.DateTimeField(db_column='IMOrderDate',
                                        auto_now_add=True)
    order_amount = models.DecimalField(decimal_places=4,
                                       null=True,
                                       max_digits=19,
                                       db_column='IMOrderAmt',
                                       blank=True,
                                       default=0.00)
    os_commission = models.FloatField(db_column='IMOSCommission',
                                      blank=True,
                                      null=False,
                                      default=0.0,
                                      help_text='OS Commission Rate')
    merchant_fee = models.FloatField(db_column='IMMerchantFee',
                                     blank=True,
                                     null=False,
                                     default=0.0,
                                     help_text='Credit Card & Paypal Fee Rate')
    invoice_star = models.SmallIntegerField(db_column='InvoiceRating',
                                            blank=True,
                                            null=True)
    store_credit = models.DecimalField(decimal_places=4,
                                       null=True,
                                       max_digits=19,
                                       db_column='IMStoreCredit',
                                       blank=True,
                                       default=0.00,
                                       help_text='used store credit')
    sub_total_amount = models.DecimalField(decimal_places=4,
                                           null=True,
                                           max_digits=19,
                                           db_column='IMSubTotal',
                                           blank=True,
                                           default=0.00,
                                           help_text='sum of order price')

    # Invoice Only Fields
    invoice_master_id = models.CharField(max_length=10,
                                         db_column='TBInvoiceMaster_ID',
                                         unique=True)
    is_captured = models.NullBooleanField(db_column='IMCaptured', default=0)
    is_declined = models.BooleanField(db_column='IMDeclined', default=0)
    is_shipped = models.NullBooleanField(db_column='IMComplete_Shipping',
                                         default=False,
                                         help_text='is this shipped out')
    actual_shipping_date = models.DateTimeField(
        db_column='IMActualShippingDate',
        blank=True,
        null=True,
    )
    for_brand_web = models.CharField(max_length=3,
                                     ...
                                     blank=True,
                                     null=True,
                                     help_text='for vendor own site order')
    authorized_response_code = models.CharField(max_length=2,
                                                db_column='AuthResponseCode',
                                                blank=True,
                                                null=True)
    authorized_response_reason_code = models.CharField(
        max_length=10,
        db_column='AuthResponseReasonCode',
        help_text='authorized.net response code',
        blank=True)
    authorized_response = models.CharField(
        max_length=1000,
        db_column='AuthResponseResonText',
        help_text='authorized.net response result message',
        blank=True)
    authorized_code = models.CharField(max_length=100,
                                       db_column='AuthApprovalCode',
                                       blank=True)
    authorized_trans_id = models.CharField(max_length=100,
                                           db_column='AuthTransID',
                                           blank=True,
                                           null=True)
    authorized_amount = models.DecimalField(decimal_places=4,
                                            null=True,
                                            max_digits=19,
                                            db_column='IMAuthorizedAmt',
                                            blank=True,
                                            default=0.00)
    captured_amount = models.DecimalField(decimal_places=4,
                                          null=True,
                                          max_digits=19,
                                          db_column='IMCapturedAmt',
                                          blank=True,
                                          default=0.00)
    captured_trans_id = models.CharField(max_length=100,
                                         db_column='CaptureTransID',
                                         blank=True,
                                         null=True,
                                         help_text='captured transaction id')
    paid_amount = models.DecimalField(decimal_places=4,
                                      null=True,
                                      max_digits=19,
                                      db_column='IMPaidAmt',
                                      blank=True,
                                      default=0.00)
    authorized_date = models.DateTimeField(null=True,
                                           db_column='IMAuthorizedDate',
                                           blank=True)
    captured_user = models.CharField(max_length=50,
                                     db_column='CapturedUser',
                                     blank=True,
                                     null=True)
    captured_date = models.DateTimeField(db_column='CapturedDate',
                                         blank=True,
                                         null=True)
    balance_amount = models.DecimalField(
        ...
        blank=True,
        default=0.00,
        help_text='remain balance. due amount - payed amount')
    confirmed_date = models.DateTimeField(null=True,
                                          db_column='IMConfirmedDate',
                                          blank=True)
    created_date = models.DateTimeField(null=True,
                                        db_column='IMInputDateAndTime',
                                        blank=True,
                                        auto_now_add=True)
    brand_discount_amount = models.DecimalField(decimal_places=4,
                                                null=True,
                                                max_digits=19,
                                                db_column='DiscountedAmount',
                                                default=0.00,
                                                help_text='discount amount')
    os_discount_amount = models.DecimalField(
        decimal_places=4,
        null=True,
        max_digits=19,
        db_column='OSDiscountedAmount',
        default=0.00,
        help_text='os coupon discounted amount')
    due_amount = models.DecimalField(decimal_places=4,
                                     null=True,
                                     max_digits=19,
                                     db_column='IMDueAmt',
                                     blank=True,
                                     default=0.00,
                                     help_text='final charged price')
    shipping_fee = models.DecimalField(decimal_places=4,
                                       null=True,
                                       max_digits=19,
                                       db_column='IMInvoiceFChg',
                                       blank=True,
                                       default=0.00,
                                       help_text='shipping fee')
    handling_fee = models.DecimalField(decimal_places=4,
                                       null=True,
                                       max_digits=19,
                                       db_column='IMInvoiceHFee',
                                       blank=True,
                                       default=0.00,
                                       help_text='handling fee')
    shipped_date = models.DateTimeField(db_column='IMShippingDate',
                                        blank=True,
                                        null=True)
    shipping_tracking_number = models.CharField(
        max_length=60,
        db_column='ShippingTrackingNo',
        blank=True,
    ...
    po_number = models.CharField(db_column='IMPONumber',
                                 max_length=20,
                                 blank=True,
                                 null=True,
                                 help_text='COD NUMBER')
    _ara_add = models.CharField(max_length=1,
                                db_column='TAdd',
                                blank=True,
                                default='N',
                                help_text='for ARA')
    _ara_update = models.CharField(max_length=1,
                                   db_column='TUpdate',
                                   blank=True,
                                   default='N',
                                   help_text='for ARA')
    afconfirm = models.CharField(max_length=1,
                                 db_column='AFConfirm',
                                 blank=True,
                                 default='N',
                                 help_text='unknown')
    amount_discount = models.IntegerField(db_column='AmountDiscount',
                                          null=True,
                                          blank=True,
                                          default=0)
    amount_discount_percentage = models.IntegerField(
        null=True, db_column='AmountDiscountPercentage', blank=True, default=0)
    estimate_sp_fee = models.DecimalField(decimal_places=4,
                                          null=True,
                                          max_digits=19,
                                          db_column='IMInvoiceEstimatedSPF',
                                          blank=True,
                                          default=0.00,
                                          help_text=u'estimated shipping fee')
    estimate_sp_weight = models.FloatField(
        help_text='estimated shipping weight',
        db_column='IMInvoiceEstimatedSPW',
        default=0.00,
        blank=True,
        null=True)
    card_ccv = models.CharField(max_length=255,
                                db_column='CardSecurityCode',
                                blank=True)
    ...
    def save(self, *args, **kwargs):
        ...
        self.due_amount = self.sub_total_amount - self.store_credit - self.brand_discount_amount - self.os_discount_amount
        ...
        try:
            ...
            if not self.pk and hasattr(
                    e, 'args') and 'The duplicate key value' in e.args[-1]:
...
class MasterInvoiceModel(AbstractMasterInvoiceModel):
    user = models.ForeignKey('meta_db.UserModel',
                             ...
                             related_name='master_invoice',
                             on_delete=models.DO_NOTHING)
    shipping_method = models.ForeignKey('meta_db.ShippingMethodModel',
                                        db_column='TBShipMethod_ID',
                                        to_field='sp_id',
                                        on_delete=models.DO_NOTHING)
    # TODO: update payment_method not sql id. authorized.net id -- ?
    payment_method = models.ForeignKey(
        'meta_db.PaymentMethodModel',
        db_column='TBSaleMethod_ID',
        on_delete=models.DO_NOTHING,
        help_text='FK. payment method id. Table = TBSaleMethod')
    invoice_status = models.ForeignKey('meta_db.MasterInvoiceStatusModel',
                                       db_column='IMStatus',
                                       on_delete=models.DO_NOTHING,
                                       help_text='order status')
    fulfilled_by = models.ForeignKey('meta_db.FulfillmentModel',
                                     db_column='ShippedFrom',
                                     to_field='fulfillment',
                                     blank=True,
                                     null=True,
                                     on_delete=models.DO_NOTHING)
    _auth_count = models.CharField(db_column='AuthCode',
                                   max_length=255,
                                   blank=True,
                                   null=True,
                                   help_text='count authorization')
    is_void = models.NullBooleanField(db_column='IMVoid',
                                      blank=True,
                                      null=True,
                                      default=False)
    void_reason = models.CharField(max_length=500,
                                   db_column='IMVoidReason',
                                   blank=True,
                                   default='')
    void_reason_code = models.CharField(db_column='VoidReasonCode',
                                        ...
                                        null=True,
                                        blank=True)
    voided_date = models.DateTimeField(db_column='IMVoidDate', null=True)
    invoice_dc_amt = models.DecimalField(decimal_places=4,
                                         null=True,
                                         max_digits=19,
                                         db_column='IMInvoiceDCAmt',
                                         blank=True,
                                         default=0.00,
                                         help_text='manual brand discount')
    origin_status = models.IntegerField(db_column='OriginStatus', default=0)
    is_additional_order = models.NullBooleanField(
        db_column='IsAdditionalOrder', blank=True, null=True, default=False)
    origin_order = models.ForeignKey(
        'MasterInvoiceModel',
        db_column='OriginOrderID',
    ...
    signature_requested = models.BooleanField(db_column='signature_requested',
                                              default=False)
    ...
    def is_brand_fulfillment(self):
        return False if self.fulfilled_by.fulfillment in ('OrangeShine.com',
                                                          'OS SHOES') else True

    @property
    def order_number(self):
        return self.invoice_master_id

    @property
    def order_status(self):
        # TODO: add void field on Meta
        INVOICE_STATUS = settings.ORDER_STATUS['in-stock']
        return INVOICE_STATUS[self.invoice_status.id]

    @property
    def order_star(self):
        return self.invoice_star

    @order_star.setter
    def order_star(self, val):
        self.invoice_star = val

    @property
    def auth_count(self):
        try:
            return int(self._auth_count or 0)
        except ValueError as e:
            print("[Invoice][AuthCount][ValueError]", e)
            return 0

    @auth_count.setter
    def auth_count(self, val):
        c = int(self._auth_count or 0)
        try:
            c = val
        except ValueError as e:
            print("[Invoice][AuthCount][ValueError]", e)
        self._auth_count = str(c)

    @property
    def is_void_requested(self):
        return True if self.is_void and int(
            self.invoice_status_id) not in (5, 23) else False

    @property
    def shipped_from(self):
        fulfillment_name = ''
        if self.fulfilled_by_id:
            if self.fulfilled_by_id.startswith('CM_'):
                fulfillment_name = self.fulfilled_by_id[3:]
            else:
                fulfillment_name = self.fulfilled_by_id
        return fulfillment_name

    @property
    def get_status_name(self):
        INVOICE_STATUS = settings.ORDER_STATUS['in-stock']
        try:
            if self.is_void and int(self.invoice_status_id) not in (5, 23):
                return "Void Requested"
            else:
                return INVOICE_STATUS[int(self.invoice_status_id)]
        except:
            return ""

    @property
    def is_returnable(self):
        before_date = datetime.today() - timedelta(days=15)
        if int(self.invoice_status_id) == 4 and self.shipped_date >= before_date:
            return True
        return False

    @property
    def auth_form_required(self):
        if int(
                self.invoice_status_id
        ) == 8 and self.payment_method_id == 'WH1' and self.invoice_star <= 2:
            return not CreditCardAuthorizationFormModel.objects.filter(
                id=self.payment_profile_id).exclude(
                    status="InReview").exists()
        return False

    @property
    def auth_form_confirmed(self):
        return CreditCardAuthorizationFormModel.objects.filter(
            id=self.payment_profile_id, confirmed=True).exists()
...
class AbstractSubInvoiceModel(models.Model):
    ...
    line_id = models.CharField(max_length=10,
                               db_column='TBInvoiceSub_ID',
                               unique=True)
    description = models.CharField(max_length=3000,
                                   db_column='ISDescription',
                                   blank=True)
    purchase_price = models.DecimalField(decimal_places=4,
                                         null=True,
                                         max_digits=19,
                                         db_column='ISPurchasePrice',
                                         blank=True)
    retail_price = models.DecimalField(decimal_places=4,
                                       null=True,
                                       max_digits=19,
                                       db_column='ISSalePrice',
                                       blank=True,
                                       help_text='retail price')
    discount_price = models.DecimalField(decimal_places=4,
                                         null=True,
                                         max_digits=19,
                                         db_column='ISnDiscountPrice',
                                         blank=True,
                                         default=0.0)
    package_qty = models.IntegerField(null=True,
                                      db_column='ISPackageSoo',
                                      blank=True)
    ...
    total_item_qty = models.SmallIntegerField(null=True,
                                              db_column='ISTotal',
                                              blank=True)
    sub_total = models.DecimalField(db_column='ISSubTotal',
                                    decimal_places=4,
                                    max_digits=19)
    stock_state = models.CharField(max_length=10,
                                   db_column='TInstockOrSoldout',
                                   blank=True,
                                   default="I",
                                   help_text='I: in-stock, S: sold out')
    ...
    preorder_available_date = models.DateTimeField(
        db_column='nPreOrderAvailableDate', blank=True, null=True)
    _ara_add = models.CharField(max_length=1, db_column='TAdd', default='Y')
    _ara_update = models.CharField(max_length=1,
                                   db_column='TUpdate',
                                   default='N')
    is_added = models.BooleanField(db_column='isAdded', default=False)
    combined_from = models.CharField(max_length=10,
                                     db_column='combined_from',
                                     null=True)
...
class SubInvoiceModel(AbstractSubInvoiceModel):
    master_order = models.ForeignKey('MasterInvoiceModel',
                                     db_column='TBInvoiceMaster_ID',
                                     to_field='invoice_master_id',
                                     related_name='sub_invoices',
                                     on_delete=models.DO_NOTHING)
    ...
    shoe_size = models.ForeignKey('meta_db.ShoeSizeChartModel',
                                  ...
                                  null=True,
                                  on_delete=models.DO_NOTHING)
    line_status = models.ForeignKey('InvoiceSubStatusModel',
                                    db_column='TBInvoiceSubStatus_ID',
                                    on_delete=models.DO_NOTHING)
    org_size_pack = JSONField('org_size_pack', blank=True,
                              null=True)  # original size pack info
    ...
    def size_run(self):
        _fields = [
            ...
            'iss9', 'iss10', 'iss11', 'iss12', 'iss13', 'iss14', 'iss15',
            'iss16'
        ]
        if self.shoe_size_id:
            _size_list = self.shoe_size.shoe_size_chart_label
            _obj = [getattr(self, i) for i in _fields]
        else:
            if self.org_size_pack:
                _size_list = self.org_size_pack['size_chart']
            else:
                _size_list = self.item.size_chart.size_list
            _obj = [getattr(self, i) for i in _fields[:len(_size_list)]]
        return OrderedDict(zip(_size_list, _obj))

    @property
    def is_reorderable(self):
        if self.item.only_colors.filter(item=self.item,
                                        color=self.color,
                                        _is_active='Y').exists():
            return True
        else:
    ...
    @property
    def is_broken_pack(self):
        return self.item.is_broken_pack
...
class AbstractInvoiceSubStatusModelManager(models.Manager):
    def all_active(self):
        return super(AbstractInvoiceSubStatusModelManager,
...
def _get_unique_invoice_id(obj):
    ...
    try:
        while True:
            ...
            except _class.MultipleObjectsReturned:
                pass
            _key += 1
            _candidate_id = "WB%s" % _key
