...
class AbstractVendorLinesheetSendModel(models.Model):
    ...
    linesheet_name = models.CharField(max_length=128,
                                      db_column='linesheet_name')
    display_options = models.CharField(max_length=20,
                                       db_column='display_options')
...
class AbstractVendorLinesheetScheduledModel(models.Model):
    ...
    email_title = models.CharField(max_length=128,
                                   db_column='email_title',
                                   blank=True)
    message = models.CharField(max_length=128, db_column='message', blank=True)
    schedule_date = models.DateTimeField(db_column='schedule_date', blank=True)
    recipient_type = models.CharField(max_length=1,
        ...
        if not self.pk:
            while True:
                ...
                try:
                    ...
                    self.id = _id
                    break
        super(AbstractVendorLinesheetScheduledModel,
...
class VendorLinesheetScheduledModel(AbstractVendorLinesheetScheduledModel):
    linesheetsend = models.ForeignKey('VendorLinesheetSendModel',
                                      db_column='linesheetsend_id',
                                      related_name='by_linesheetsend',
...
class AbstractVendorLinesheetItemScheduledModel(models.Model):
    id = models.CharField(max_length=40, primary_key=True)
    selected_pictures = models.CharField(max_length=300,
                                         db_column='selected_pictures',
                                         null=True,
                                         blank=True)
    created = models.DateTimeField(db_column='created', auto_now_add=True)
        ...
        if not self.pk:
            while True:
                ...
                try:
                    ...
                    self.id = _id
                    break
        super(AbstractVendorLinesheetItemScheduledModel,
              self).save(*args, **kwargs)
...
class VendorLinesheetItemScheduledModel(
        AbstractVendorLinesheetItemScheduledModel):
    linesheetsend = models.ForeignKey('VendorLinesheetSendModel',
                                      db_column='linesheetsend_id',
                                      related_name='by_linesheetitem',
                                      on_delete=models.DO_NOTHING)
...
class VendorLinesheetContactGroupModel(AbstractVendorLinesheetContactGroupModel
    ...
    linesheetscheduled = models.ForeignKey(
        'VendorLinesheetScheduledModel',
        db_column='linesheetscheduled_id',
        related_name='by_linesheetscheduled',
        on_delete=models.DO_NOTHING)
    contactgroup = models.ForeignKey('VendorContactGroupModel',
                                     db_column='contactgroup_id',
                                     related_name='by_contactgroup',
                                     on_delete=models.DO_NOTHING)
...
class VendorContactModel(AbstractVendorContactModel):
    ...
    contactemail = models.ForeignKey('VendorContactEmailModel',
                                     db_column='contactemail_id',
                                     on_delete=models.DO_NOTHING,
                                     related_name='by_contacts')
...
class VendorLinesheetSentLogModel(AbstractVendorLinesheetSentLogModel):
    linesheetscheduled = models.ForeignKey('VendorLinesheetScheduledModel',
                                           db_column='linesheetscheduled_id',
                                           on_delete=models.DO_NOTHING)
...
class AbstractVendorSchedulerTitleModel(models.Model):
    ...
    _is_add_date = models.CharField(max_length=1,
                                    db_column='is_add_date',
                                    default='N')
    created = models.DateTimeField(db_column='created', auto_now_add=True)
...
class VendorSchedulerTitleModel(AbstractVendorSchedulerTitleModel):
    scheduler = models.ForeignKey('VendorSchedulerModel',
                                  db_column='scheduler_id',
                                  on_delete=models.DO_NOTHING)
